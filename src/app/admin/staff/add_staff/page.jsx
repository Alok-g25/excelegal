...
import { addStaffAction } from "@/app/redux/actions";
  ...
  function submitData(event) {
    ...
    if (
      ...
      if (!comparePasswords(staffData.password, staffData.c_password)) {
        ...
        const finalData = {
          name:
            staffData.f_name + (staffData.l_name ? " " + staffData.l_name : ""),
          profile: staffData.image ? staffData.image : "",
          email: staffData.email,
          phone: staffData.phone,
          password: staffData.password,
          subRole: staffData.subRole.toUpperCase(),
          role: "STAFF",
        };
        // console.log(finalData,"********************************************")
        setLoader(true)
        dispatch(
          addStaffAction(finalData, (response) => {
