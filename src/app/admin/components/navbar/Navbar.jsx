    ...
    <>
      <li>
        <Link
          ...
          className={`text-md font-bold px-3 py-1 rounded-md ${activeLink === '/admin/dashboard' ? 'border-b border-yellow-500' : ''}`}
      ...
      <li>
        <Link
          href="/admin/banner"
          className={`text-md font-bold px-3 py-1 rounded-md ${activeLink === '/admin/banner' ? 'border-b border-yellow-500' : ''}`}
      ...
      <li>
        <Link
          href="/admin/staff"
          className={`text-md font-bold px-3 py-1 rounded-md ${activeLink === '/admin/staff' ? 'border-b border-yellow-500' : ''}`}
      ...
      <li>
        <Link
          ...
          className={`text-md font-bold px-3 py-1 rounded-md ${activeLink === '/admin/categories' ? 'border-b border-yellow-500' : ''}`}
      ...
      <li>
        <Link
          href="/admin/course"
          className={`text-md font-bold px-3 py-1 rounded-md ${activeLink === '/admin/course' ? 'border-b border-yellow-500' : ''}`}
      ...
      <li>
        <Link
          href="/admin/question"
          className={`text-md font-bold px-3 py-1 rounded-md ${activeLink === '/admin/question' ? 'border-b border-yellow-500' : ''}`}
      ...
      <li>
        <Link
          href="/admin/quiz"
          className={`text-md font-bold px-3 py-1 rounded-md ${activeLink === '/admin/quiz' ? 'border-b border-yellow-500' : ''}`}
      ...
      <div className="navbar relative">
        <div className="navbar-start">
          ...
          <Link href="/admin/dashboard">
            <h1
              className="font-bold flex gap-2 text-xl justify-center"
            >
              <AccountBalanceIcon className="text-xl lg:text-3xl hidden md:block" />{" "}
              Excelegal
            </h1>
          </Link>
        </div>
