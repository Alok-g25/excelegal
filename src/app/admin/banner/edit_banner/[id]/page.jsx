...
function EditBannerPage() {
  ...
  function submitData(e) {
    ...
    if (
      ...
      let finalData;
      if (!myImg) {  
        finalData={_id: id,description:description }   
        }else {
        finalData ={ image: myImg, _id: id,description:description }
      }
        // console.log(finalData);
        dispatch(
          updateBannerAction(finalData, (response) => {
  ...
  useEffect(() => {
    setLoader(true);
    dispatch(
      getSingleBannerAction(id, (response) => {
        if (response?.data?.success) {
          setShowImg(true);
